...
BUBBLLE_CLIENT_VERSION = os.environ.get("BUBBLLE_CLIENT_VERSION", "11")
...
# AI cost control — keep rooms alive without constant LLM spend
BUBBLLE_AI_MAX_MESSAGES_PER_BUBBLE_DAY = int(
    os.environ.get("BUBBLLE_AI_MAX_MESSAGES_PER_BUBBLE_DAY", "20")
)
BUBBLLE_AI_MAX_MESSAGES_PLATFORM_DAY = int(
    os.environ.get("BUBBLLE_AI_MAX_MESSAGES_PLATFORM_DAY", "200")
)
BUBBLLE_AI_INACTIVE_MIN_MINUTES = int(os.environ.get("BUBBLLE_AI_INACTIVE_MIN_MINUTES", "3"))
BUBBLLE_AI_INACTIVE_MAX_MINUTES = int(os.environ.get("BUBBLLE_AI_INACTIVE_MAX_MINUTES", "10"))
BUBBLLE_AI_HUMAN_QUIET_MINUTES = int(os.environ.get("BUBBLLE_AI_HUMAN_QUIET_MINUTES", "5"))
BUBBLLE_AI_MESSAGES_PER_CYCLE_MIN = int(os.environ.get("BUBBLLE_AI_MESSAGES_PER_CYCLE_MIN", "1"))
BUBBLLE_AI_MESSAGES_PER_CYCLE_MAX = int(os.environ.get("BUBBLLE_AI_MESSAGES_PER_CYCLE_MAX", "3"))
BUBBLLE_AI_SEED_INITIAL_MESSAGES = int(os.environ.get("BUBBLLE_AI_SEED_INITIAL_MESSAGES", "5"))
BUBBLLE_AI_SEED_SCHEDULED_MESSAGES = int(os.environ.get("BUBBLLE_AI_SEED_SCHEDULED_MESSAGES", "18"))
BUBBLLE_AI_BATCH_GENERATE_SIZE = int(os.environ.get("BUBBLLE_AI_BATCH_GENERATE_SIZE", "30"))
BUBBLLE_AI_REACTIVE_REPLY_ENABLED = os.environ.get("BUBBLLE_AI_REACTIVE_REPLY_ENABLED", "0") == "1"
