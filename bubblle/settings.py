...
BUBBLLE_AI_REPLY_DELAY_MIN = int(os.environ.get("BUBBLLE_AI_REPLY_DELAY_MIN", "30"))
BUBBLLE_AI_REPLY_DELAY_MAX = int(os.environ.get("BUBBLLE_AI_REPLY_DELAY_MAX", "90"))
BUBBLLE_AI_REPLY_MIN_GAP = int(os.environ.get("BUBBLLE_AI_REPLY_MIN_GAP", "30"))
